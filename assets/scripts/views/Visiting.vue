<template>
    <section class="post">
        ...
        <p>
            ...
            divided into quadrants: Southwest, Northwest, Southeast, and Northeast.
            There is a ton of stuff to do here! Just pick a quadrant and you're bound
            to find fun restaurants, bars, and parks within walking distance. You'll
            find it's pretty easy to get around town without a car.
        </p>
        <h3>Clothing</h3>
        <p>
            It will be hot! Please dress for warm weather and cool nights. It typically
            gets in the 90s during the day and the 60s at night. Portland is also a casual
            city, so don't feel any pressure to dress up. It's got that west coast vibe.
        </p>
        <h3>Lodging</h3>
        <p>
        ...
        <h3>Food</h3>
        <p>
            In case you didn't know, Portland's kind of a foodie city. We have some of the
            best food around and it's not really that expensive. If you're paying 15+ a meal
            in town, you're paying too much. There is an abundance of amazing cuisine in Portland.
            Don't eat at a chain! There is probably something better around the corner. Here are
